...
\pagestyle{fancy}
\lhead{CMSC 125: Operating Systems \\ Second Semester 2018-2019}
...
\noindent\fbox{
	\parbox{\textwidth}{
	\textbf{QUESTIONS}(Provide screenshots to support your answer):
	\begin{enumerate}[itemsep=0pt,parsep=0pt]
	...
	\item{Examine \texttt{kernel/console/console.c}. What console commands use the functions in Q3?} 
	\end{enumerate}	
	}
}
...
Build and boot ICS-OS. Once inside ICS-OS,  run the following command line sequence and capture a screenshot.	
