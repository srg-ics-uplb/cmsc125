...
|-----------------|---|---|---|---|---|---|---|
| CO 1. Describe the purpose and functions of an operating system. | I | D | | | | | | 
| CO 2. Design and implement programs to perform simple operating system tasks. | D | D | | | | | | 
| CO 3. Implement and evaluate the performance of different operating system algorithms. | D | D | | | | | |
